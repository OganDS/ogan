        ...
        <center>
            <div style="padding-top: 125px;">
                <a href="index.php" onclick="window.close();">
                    <img src="image/hey.png" class="img-responsive" style="width: 100px; height: 100px;">
                </a>
                ...
                <div class="container" style="width: 500px;">
                    ...
                    <p class="left">Anda sudah punya akun? Silahkan langsung Login.</p><a href="signin.php" style="font-family: segoe ui light;"><button class="btn waves-effect">Sign In  <i class="ion-log-in"></i></button></a>
                </div>
            </div>
        </center>
    </div>
