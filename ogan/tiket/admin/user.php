...
<body>
    ...
    <div class="container">
                    ...
                    <table>
                        ...
                        <tbody class="white-text">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="user_d.php?id_user=<?=$dtt['id_user'];?>" onclick="return confirm('Admin Yakin ingin menghapusnya?');"><button class="btn waves-effect red white-text"><i class="ion-android-delete"></i></button></a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
        ...
        <a style="" href="reserv.php"><button class="btn waves-effect blue">Reservation</button></a>
